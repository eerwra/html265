...
(function($) {
    $.fn.colorList = function() {
        return this.each(function() {
            $(this).append($("<option></option>").attr("value", "LightGoldRodYellow").text("黃色"));
            $(this).append($("<option></option>").attr("value", "PaleGreen").text("綠色"));
            $(this).append($("<option></option>").attr("value", "LightPink").text("粉紅色"));
            $(this).append($("<option></option>").attr("value", "LightBlue").text("藍色"));
        });
    };
})(jQuery);
